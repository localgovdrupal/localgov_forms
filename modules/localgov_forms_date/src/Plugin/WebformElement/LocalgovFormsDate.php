...
class LocalgovFormsDate extends DateList {
  ...
  public static function validateDate(&$element, FormStateInterface $form_state, &$complete_form) {
    ...
    $localgov_forms_date_uk_short_date_format = DateFormat::load('localgov_forms_date_uk_html_short_date')->getPattern();
    $localgov_forms_date_uk_datetime_format = DateFormat::load('localgov_forms_date_uk_html_datetime')->getPattern();

    $element['#date_date_format'] = $localgov_forms_date_uk_short_date_format;
    $element['#date_time_format'] = $localgov_forms_date_uk_datetime_format;
